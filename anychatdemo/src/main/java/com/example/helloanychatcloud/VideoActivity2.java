...
//
//public class VideoActivity2 extends Activity implements AnyChatBaseEvent {
//
...
//				{
//					if (videoBitrate <= 0){
//						Toast.makeText(VideoActivity2.this, "对方视频中断了!", Toast.LENGTH_SHORT).show();
//						// 重置下，如果对方退出了，有进去了的情况
...
//					if (audioBitrate <= 0){
//						Toast.makeText(VideoActivity2.this, "对方音频中断了!", Toast.LENGTH_SHORT).show();
//						// 重置下，如果对方退出了，有进去了的情况
...
//		if (!bEnter) {
//			if (dwUserId == userID) {
//				Toast.makeText(VideoActivity2.this, "对方已离开！", Toast.LENGTH_SHORT).show();
//				userID = 0;
